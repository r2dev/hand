...
set CommonCompillerFlags=-MTd -nologo -Zo -O2 -Gm- -GR- -EHa- -W4 -Gm- -GR- -EHa- -wd4201 -wd4100 -wd4456 -wd4189  -wd4505 -WX -DHANDMADE_WIN32=1 -DHANDMADE_SLOW=1 -DHANDMADE_INTERNAL=1 -Z7 -FC

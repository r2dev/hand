...
{
  {0, MetaType_b32, "UnitMaxAccelVector", (u32)&((move_spec *)0)->UnitMaxAccelVector},
  {0, MetaType_r32, "Speed", (u32)&((move_spec *)0)->Speed},
  {0, MetaType_r32, "Drag", (u32)&((move_spec *)0)->Drag},
};
member_definition MembersOf_hit_point[] = 
{
  {0, MetaType_u8, "Flag", (u32)&((hit_point *)0)->Flag},
  {0, MetaType_u8, "FilledAmount", (u32)&((hit_point *)0)->FilledAmount},
};

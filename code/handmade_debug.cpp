        ...
        while (Ref) {
            ...
            switch(Var->Type) {
                case DebugVariableType_CounterThreadList: {
                    ...
                    SizeInteraction.P = &Var->ProfileSetting.Dimension;
